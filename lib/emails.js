          ...
          <tr>
            <td style="padding:40px 40px 32px;">
                ...
                <tr>
                  <td style="padding:24px 28px;">
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
                      <tr><td style="padding:7px 0;font-size:14px;color:#c4c0dc;">→ &nbsp;Declaras tu objetivo al grupo antes de empezar</td></tr>
                      <tr><td style="padding:7px 0;font-size:14px;color:#c4c0dc;">→ &nbsp;Sprint de 2h20 con cámaras encendidas, sin distracciones</td></tr>
                      <tr><td style="padding:7px 0;font-size:14px;color:#c4c0dc;">→ &nbsp;Demo de 5 min: muestras lo que hiciste. Sin excusas.</td></tr>
              ...
              <p style="margin:0 0 32px;font-size:15px;color:#a09db8;line-height:1.7;">
                Si conoces a alguien que procrastina con sus proyectos, mándale el link.<br />
...
<body style="margin:0;padding:0;background:#0a0a0f;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;">
  <table width="100%" cellpadding="0" cellspacing="0" role="presentation" style="background:#0a0a0f;padding:48px 16px;">
    <tr><td align="center">
      <table width="580" cellpadding="0" cellspacing="0" role="presentation" style="max-width:580px;width:100%;background:#12121a;border-radius:16px;border:1px solid rgba(124,58,237,0.25);overflow:hidden;">
        <tr><td style="padding:32px 40px 28px;border-bottom:1px solid rgba(124,58,237,0.18);">
          <p style="margin:0;font-family:'Courier New',monospace;font-size:22px;font-weight:700;color:#a855f7;letter-spacing:-0.5px;">hackr_</p>
        </td></tr>
        <tr><td style="padding:40px 40px 32px;">
          <h1 style="margin:0 0 12px;font-size:28px;font-weight:800;color:#f1f0ff;line-height:1.2;letter-spacing:-0.03em;">Bienvenido, ${name}.</h1>
          <p style="margin:0 0 24px;font-size:16px;color:#a09db8;line-height:1.7;">
            Tu cuenta en Hackr está lista. Ahora puedes reservar tu lugar en las sesiones y construir junto a otros builders.
          </p>
          <table width="100%" cellpadding="0" cellspacing="0" role="presentation" style="background:#1a1a26;border-radius:12px;border:1px solid rgba(124,58,237,0.15);margin:0 0 32px;">
            <tr><td style="padding:24px 28px;">
              <p style="margin:0 0 14px;font-family:'Courier New',monospace;font-size:11px;font-weight:700;letter-spacing:0.12em;text-transform:uppercase;color:#a855f7;">Próximos pasos</p>
              <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
                <tr><td style="padding:6px 0;font-size:14px;color:#c4c0dc;">→ &nbsp;Revisa las sesiones disponibles</td></tr>
                <tr><td style="padding:6px 0;font-size:14px;color:#c4c0dc;">→ &nbsp;Reserva tu lugar en la que más te acomode</td></tr>
                <tr><td style="padding:6px 0;font-size:14px;color:#c4c0dc;">→ &nbsp;Llega con un objetivo claro el día de la sesión</td></tr>
              </table>
            </td></tr>
          </table>
          <table cellpadding="0" cellspacing="0" role="presentation">
            <tr><td style="border-radius:10px;background:linear-gradient(135deg,#7c3aed,#f97316);padding:1px;">
              <a href="https://hackr.app/#sessions" target="_blank"
                 style="display:block;border-radius:9px;background:#12121a;padding:14px 32px;font-size:15px;font-weight:700;color:#f1f0ff;text-decoration:none;letter-spacing:-0.01em;">
                Ver sesiones →
              </a>
        ...
        <tr><td style="padding:22px 40px;border-top:1px solid rgba(124,58,237,0.12);">
          <p style="margin:0;font-size:12px;color:#3d3a52;line-height:1.6;">
            Construido por builders, para builders. · Santiago de Chile · 2026<br />
            Recibiste este email porque creaste una cuenta en hackr.app.
          </p>
        </td></tr>
      </table>
    </td></tr>
  ...
  try {
    return await getResend().emails.send({
      from: FROM,
      to: email,
      subject: `Bienvenido a Hackr, ${name}`,
      html,
    });
  } catch (err) {
    console.error('[email] sendWelcome error:', err.message);
    return null;
  }
}
...
module.exports = { sendConfirmation, sendAdminNotification, sendSessionConfirmation, sendSessionAdminNotification, sendWelcome, sendWelcomeEmail };
